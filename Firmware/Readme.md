...
***Note to myself:*** After generating new doxygen documentation, all output files are generated on doxygen out folder. This folder is ignored by Git. Final output (refman.pdf) should be coppied as aPCmeter/aPCmeter.pdf.
